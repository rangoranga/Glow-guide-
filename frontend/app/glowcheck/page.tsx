    ...
    <main className="min-h-screen bg-black px-4 py-8 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        <section className="mb-8">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-white/45">GlowCheck</p>
...
function AnalysisCard({ analysis, posted }: { analysis: GlowCheckAnalysis; posted: boolean }) {
  return (
    <section className="rounded-2xl border border-white/10 bg-white/[0.05] p-5">
      <p className="text-sm font-semibold text-white/55">GlowCheck result</p>
